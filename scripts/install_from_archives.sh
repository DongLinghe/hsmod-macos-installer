...
APP_PATH="$WORK_DIR/HsMod Reinject Runtime.app"
...
chmod +x "$APP_PATH/Contents/MacOS/reinject_current_hsmod.sh" "$APP_PATH/Contents/Resources/restore_original_hearthstone.sh"
xattr -cr "$APP_PATH"
codesign -f -s - "$APP_PATH"

"$APP_PATH/Contents/MacOS/reinject_current_hsmod.sh" "$HEARTHSTONE_APP"
